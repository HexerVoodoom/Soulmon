        ...
        <div className={`w-full max-w-md max-h-[80vh] overflow-y-auto rounded-lg shadow-2xl ${
          ...
          <div className={`p-4 space-y-4 ${
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-xs mt-0.5 ${
                      ...
                      {useAI ? 'Usando IA avançada (Groq)' : 'Usando respostas por palavras-chave'}
                    </p>
                  </div>
                </div>
                <button
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className={`text-xs mt-0.5 ${
                      ...
                      Personalize a personalidade do companheiro
                    </p>
                  </div>
                </div>
            ...
            <div className={`p-3 rounded border text-xs ${
              ...
              💡 <strong>Dica:</strong> Com AI Chat ativado, seu companheiro pode criar atividades automaticamente quando você pedir!
            </div>
