      ...
      <div className={`w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-lg shadow-2xl ${
        ...
        <div className={`p-4 space-y-6 ${
          ...
          <div className={`p-3 rounded border ${
            ...
            💡 Customize como seu companheiro digital conversa com você! Essas configurações afetam a personalidade da IA.
          </div>
          ...
          <div>
            ...
            <p className={`text-xs mt-1 ${
              ...
              {settings.tone === 'casual' && 'Linguagem descontraída: "oi, tá, bora"'}
              {settings.tone === 'energetic' && 'Muito animado: "BOOORA! 🔥"'}
              {settings.tone === 'calm' && 'Tranquilo e sereno: "vamos com calma..."'}
              {settings.tone === 'playful' && 'Divertido e cheio de piadas'}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                { value: 'encouraging', label: '🌟 Encorajador', desc: 'Sempre positivo' },
                { value: 'challenging', label: '🔥 Desafiador', desc: 'Te provoca' },
                { value: 'supportive', label: '💚 Acolhedor', desc: 'Muito carinhoso' },
                { value: 'balanced', label: '⚖️ Equilibrado', desc: 'Mix de tudo' }
          ...
          <div>
            <label className={`flex items-center gap-2 mb-2 ${
              ...
              🏷️ Palavras-chave Personalizadas
            </label>
            <textarea
              value={settings.customKeywords}
              onChange={(e) => setSettings({ ...settings, customKeywords: e.target.value })}
              placeholder="Ex: sempre diga 'parceiro', evite 'chefe', use gírias brasileiras..."
            ...
            <p className={`text-xs mt-1 ${
              ...
              💡 Instruções adicionais para personalizar ainda mais
            </p>
          </div>
          ...
          <div>
            <label className={`flex items-center gap-2 mb-2 ${
              ...
              🌡️ Criatividade: {settings.temperature.toFixed(2)}
            </label>
            <input
              type="range"
              min="0.5"
            ...
            <div className="flex justify-between text-xs mt-1" style={{ fontFamily: 'monospace' }}>
              <span className={isGlitch ? 'text-[#ff00ff]' : 'text-gray-500'}>Conservador</span>
              <span className={isGlitch ? 'text-[#ff00ff]' : 'text-gray-500'}>Criativo</span>
            </div>
          </div>
