    ...
    items: [
      {
        ...
        descEn: 'Appears up to twice a day (never while asleep). Give a bath (requires full energy) to clean it. While left uncleaned it drains 1 heart every 6 hours.',
        descPt: 'Aparece até duas vezes por dia (nunca dormindo). Dê banho (energia cheia necessária) para limpar. Enquanto não limpo, tira 1 coração a cada 6 horas.',
      },
    ],
  },
];
