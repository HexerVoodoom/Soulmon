...
const SECTIONS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        descEn: 'Fills only by feeding from the Items menu and resets each day. Perfect day = complete your daily goal (all registered tasks, up to the stage requirement) + FULL energy at day\'s end.',
        descPt: 'Sobe apenas alimentando pelo menu Itens e zera todo dia. Dia perfeito = cumprir a meta diária (tudo que cadastrou, até o requisito do estágio) + energia CHEIA no fim do dia.',
      },
    ],
  },
  {
