...
const SECTIONS = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        descEn: 'Fills only by feeding from the Items menu and resets each day. Must be FULL at the end of the day for the day to count as perfect (evolution point).',
        descPt: 'Sobe apenas alimentando pelo menu Itens e zera todo dia. Precisa estar CHEIA no fim do dia para o dia contar como perfeito (ponto de evolução).',
      },
    ],
  },
  {
